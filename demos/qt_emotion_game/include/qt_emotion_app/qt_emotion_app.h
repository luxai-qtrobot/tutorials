...
#ifndef qt_emotion_app
#define qt_emotion_app
...
#include "qt_emotion_app/qt_service_helper.h"
//#include "qt_emotion_app/suspend.h"
...
class QTEmotionApp {
public:
    QTEmotionApp(ros::NodeHandle& nh);

    virtual ~QTEmotionApp();
    /*
    bool suspendCB(qt_emotion_app::suspend::Request  &req,
                   qt_emotion_app::suspend::Response &res) {
